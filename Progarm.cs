...
namespace OMDB
{
    class Program
    {
        ...
        public static void LogNewArtist()
        {
            ...
            File.AppendAllText(@"C:\Users\TSGA\source\repos\tsgxcode\OMDB\Data.txt", $"{"Artist: " + artist}. {"Formation Date: " + formationDate}. {"Favorite Album: " + favoriteAlbum}. {"Year Of Release: " + yearOfRelease}. {"Number Of Songs: " + numberOfSongs}. {"Genre: " + genre}" + Environment.NewLine);
        }
        ...
        public static void LogRemoveArtist()
        {
